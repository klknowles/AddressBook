...
<html>
    ...
    <body class="w3-auto">
        ...
        <div class="container" style="test-align: center;">
            <?php
                include 'connect.php';
                $result = mysqli_query($conn, "SELECT firstName, lastName, Email, imageFileName FROM contacts ORDER BY firstName");
                while ($a_row = mysqli_fetch_row($result)) {
                    print '<div class="card" style="width:400px">';
                    $val = $a_row[3];
                    echo '<img class="card-img-top" src="' . $val . '"alt="Card image" style="width:100%">';
                    print '<div class="card-body" style ="backgroound-color: Blue;" >';
